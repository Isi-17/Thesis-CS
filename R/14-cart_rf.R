...
# Define file paths
file_paths <- c("Files/sequences_output_letters7.txt", 
                "Files/sequences_output_letters14.txt", 
                "Files/sequences_output_letters21.txt", 
                "Files/sequences_output_letters28.txt")
